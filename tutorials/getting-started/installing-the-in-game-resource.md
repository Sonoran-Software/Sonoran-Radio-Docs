...
| `debug`                      | `false`                                                                                                                                                                                                                    | <p>Display tower ranges on the map and other console prints.<br>This can be toggled live with the <a href="../usage/in-game-radio/using-the-in-game-radio/fivem-commands-and-settings.md#debug-mode">server debug command</a>.</p>                     |
...
| `luxartResourceName`         | `lvc`                                                                                                                                                                                                                      | Resource name for Luxart Vehicle Control, [used for the siren volume integration](../usage/in-game-radio/using-the-in-game-radio/fivem-commands-and-settings.md#volume-change-w-sirens).                                                               |
...
</code></pre> | Default radio keybinds (these can be changed in GTA settings)                                                                                                                                                                                          |
