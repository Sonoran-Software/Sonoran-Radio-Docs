...
</code></pre> | <p>Default radio keybinds (these can be changed in GTA settings).<br><br>Use the <code>Input Parameter</code> from the <a href="https://app.gitbook.com/s/gJnyZgUQPWpA5p9njAAR/">CFX Documentation</a>.<br><br>Note that backslash <code>\\</code> must be doubled as it's a special escape character.</p> |
